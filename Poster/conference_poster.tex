...
\VeryHuge \color{HoGentAccent1} \textbf{RPA, automatisatie van morgen, vandaag} \color{Black}\\ % Title
%\Huge\textit{Ondertitel (eventueel)}\\[2.4cm] % Subtitle
\huge \textbf{Pessemier Mout, Lavaert Laurens, Decorte Johan}\\[0.5cm] % Author(s)
